eel = {
    ...
    _py_functions: ['fetch_graph_data', 'deleteStudent', 'fetch_class_data', 'get_user_details', 'photoUpload', 'teacher_login', 'fetchAttendance', 'save_photo', 'logout', 'capture_photo_py', 'start_video_py', 'submit_student_data', 'stop_video_py'],
    _start_geometry: {"default": {"position": null, "size": [1100, 600]}, "pages": {}},
